...
typedef enum CauseRadioNetwork {
	...
	CauseRadioNetwork_multiple_location_reporting_reference_ID_instances	= 47,
	CauseRadioNetwork_rsn_not_available_for_the_up	= 48,
	CauseRadioNetwork_npn_access_denied	= 49,
	CauseRadioNetwork_cag_only_access_denied	= 50,
	CauseRadioNetwork_insufficient_ue_capabilities	= 51,
	CauseRadioNetwork_redcap_ue_not_supported	= 52,
	CauseRadioNetwork_unknown_MBS_Session_ID	= 53,
	CauseRadioNetwork_indicated_MBS_session_area_information_not_served_by_the_gNB	= 54,
	CauseRadioNetwork_inconsistent_slice_info_for_the_session	= 55,
	CauseRadioNetwork_misaligned_association_for_multicast_unicast	= 56
} e_CauseRadioNetwork;
