...
asn_TYPE_member_t asn_MBR_QosFlowLevelQosParameters_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct QosFlowLevelQosParameters, qosCharacteristics),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct QosFlowLevelQosParameters, allocationAndRetentionPriority),
	...
	{ ATF_POINTER, 4, offsetof(struct QosFlowLevelQosParameters, gBR_QosInformation),
	...
	{ ATF_POINTER, 3, offsetof(struct QosFlowLevelQosParameters, reflectiveQosAttribute),
	...
	{ ATF_POINTER, 2, offsetof(struct QosFlowLevelQosParameters, additionalQosFlowInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct QosFlowLevelQosParameters, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P273,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_QosFlowLevelQosParameters_oms_1[] = { 2, 3, 4, 5 };
