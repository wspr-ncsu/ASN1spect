...
asn_TYPE_member_t asn_MBR_GBR_QosInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GBR_QosInformation, maximumFlowBitRateDL),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GBR_QosInformation, maximumFlowBitRateUL),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GBR_QosInformation, guaranteedFlowBitRateDL),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GBR_QosInformation, guaranteedFlowBitRateUL),
	...
	{ ATF_POINTER, 4, offsetof(struct GBR_QosInformation, notificationControl),
	...
	{ ATF_POINTER, 3, offsetof(struct GBR_QosInformation, maximumPacketLossRateDL),
	...
	{ ATF_POINTER, 2, offsetof(struct GBR_QosInformation, maximumPacketLossRateUL),
	...
	{ ATF_POINTER, 1, offsetof(struct GBR_QosInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P96,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_GBR_QosInformation_oms_1[] = { 4, 5, 6, 7 };
