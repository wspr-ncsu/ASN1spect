...
asn_TYPE_member_t asn_MBR_EUTRA_CGI_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_CGI, iE_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P77,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_EUTRA_CGI_oms_1[] = { 2 };
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_CGI_specs_1 = {
	...
	asn_MAP_EUTRA_CGI_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
