...
static asn_TYPE_member_t asn_MBR_PDUSessionResourceModifyConfirmTransfer_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDUSessionResourceModifyConfirmTransfer, uLNGU_UP_TNLInformation),
	...
	{ ATF_POINTER, 3, offsetof(struct PDUSessionResourceModifyConfirmTransfer, additionalNG_UUPTNLInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct PDUSessionResourceModifyConfirmTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P228,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_PDUSessionResourceModifyConfirmTransfer_oms_1[] = { 2, 3, 4 };
