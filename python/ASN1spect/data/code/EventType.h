...
typedef enum EventType {
	...
	EventType_ue_presence_in_area_of_interest	= 2,
	EventType_stop_change_of_serve_cell	= 3,
	EventType_stop_ue_presence_in_area_of_interest	= 4,
	EventType_cancel_location_reporting_for_the_ue	= 5
	/*
