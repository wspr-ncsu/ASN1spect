...
asn_TYPE_member_t asn_MBR_NRFrequencyBandItem_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NRFrequencyBandItem, iE_Extension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P197,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_NRFrequencyBandItem_oms_1[] = { 1 };
...
asn_SEQUENCE_specifics_t asn_SPC_NRFrequencyBandItem_specs_1 = {
	...
	asn_MAP_NRFrequencyBandItem_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
