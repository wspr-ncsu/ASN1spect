...
from ASN1spect.RepoParser import RepoParser
...
class ParserReplacer:
    def __init__(
        ...
        self.compile_script_path = str(
            resources.files("ASN1spect.data").joinpath("compile_asn1c.sh")
        )
        self.asn1c_output_path = str(
            resources.files("ASN1spect.data").joinpath("asn1c_output.txt")
        )
        self.base_cpp_path = str(
            resources.files("ASN1spect.data").joinpath("base.cpp")
        )
