...
asn_TYPE_member_t asn_MBR_WUS_Assistance_Information_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct WUS_Assistance_Information, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P368,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_WUS_Assistance_Information_specs_1 = {
