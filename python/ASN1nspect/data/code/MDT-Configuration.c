...
asn_TYPE_member_t asn_MBR_MDT_Configuration_1[] = {
	{ ATF_POINTER, 3, offsetof(struct MDT_Configuration, mdt_Config_NR),
	...
	{ ATF_POINTER, 2, offsetof(struct MDT_Configuration, mdt_Config_EUTRA),
	...
	{ ATF_POINTER, 1, offsetof(struct MDT_Configuration, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P173,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_MDT_Configuration_oms_1[] = { 0, 1, 2 };
