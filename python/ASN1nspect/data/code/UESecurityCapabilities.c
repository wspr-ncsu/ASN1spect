...
asn_TYPE_member_t asn_MBR_UESecurityCapabilities_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UESecurityCapabilities, nRencryptionAlgorithms),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UESecurityCapabilities, nRintegrityProtectionAlgorithms),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UESecurityCapabilities, eUTRAencryptionAlgorithms),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UESecurityCapabilities, eUTRAintegrityProtectionAlgorithms),
	...
	{ ATF_POINTER, 1, offsetof(struct UESecurityCapabilities, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P352,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
