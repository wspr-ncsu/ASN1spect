...
asn_TYPE_member_t asn_MBR_DAPSResponseInfoItem_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DAPSResponseInfoItem, dRB_ID),
	...
	{ ATF_POINTER, 1, offsetof(struct DAPSResponseInfoItem, iE_Extension),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P55,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_DAPSResponseInfoItem_specs_1 = {
