...
asn_TYPE_member_t asn_MBR_ResetType_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ResetType, choice.partOfNG_Interface),
	...
	{ ATF_POINTER, 0, offsetof(struct ResetType, choice.choice_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_SingleContainer_11857P46,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
