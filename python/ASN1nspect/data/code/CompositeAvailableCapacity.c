...
static int
memb_cellCapacityClassValue_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_capacityValue_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_cellCapacityClassValue_constr_2 CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_capacityValue_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_CompositeAvailableCapacity_1[] = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_cellCapacityClassValue_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_cellCapacityClassValue_constraint_1
		},
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_capacityValue_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_capacityValue_constraint_1
		},
		0, 0, /* No default value */
		"capacityValue"
		},
	{ ATF_POINTER, 1, offsetof(struct CompositeAvailableCapacity, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_11905P135,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
