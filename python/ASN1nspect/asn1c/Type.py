...
# from ASN1nspect.Analysis.EnumerationAnalysis import EnumerationAnalysis
from ASN1nspect.Analysis.DifferentialEnumerationAnalysis import (
    DifferentialEnumerationAnalysis,
)
from ASN1nspect.Analysis.IncompleteTypeGeneration import IncompleteTypeGeneration
from ASN1nspect.Analysis.NonEnforcedConstraintAnalysis import (
    NonEnforcedConstraintAnalysis,
)
from ASN1nspect.Analysis.RecursiveTypeAnalysis import RecursiveTypeAnalysis
from ASN1nspect.asn1c.Constraints import (
    asn_encoding_constraints,
    asn_per_encoding_constraint,
    asn_per_encoding_constraints,
)
from ASN1nspect.asn1c.Operations import asn_type_operation
...
class asn_type:
    ...
    def _analyze_members(self, struct, kind, parents, angrProj, op_symbol):
        ...
        from ASN1nspect.asn1c.Member import asn_member
